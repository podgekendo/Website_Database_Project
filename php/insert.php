...
mysql_connect("localhost", "r561250_images", "team_vermin") or die ("could not connect to mysql"); 
 mysql_select_db("r561250_images") or die ("no database");
